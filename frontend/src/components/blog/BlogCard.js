  ...
  return (
    <article className="glass-card group overflow-hidden flex flex-col h-full cursor-pointer" onClick={handleReadMore}>
      ...
      <div className="p-4 sm:p-5 md:p-6 flex flex-col flex-1">
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4 text-[9px] xs:text-[10px] sm:text-xs text-gray-400 mb-2 sm:mb-3 flex-wrap">
        ...
        <p className="text-xs sm:text-sm text-gray-300 leading-relaxed mb-3 sm:mb-4 line-clamp-2 sm:line-clamp-3 flex-1">
          {description}
        </p>

        <div className="flex items-center justify-between pt-2 sm:pt-3 md:pt-4 border-t border-gray-800 gap-2">
          <span className="text-[9px] xs:text-[10px] sm:text-xs text-gray-400 truncate max-w-[45%] sm:max-w-[40%]">By {authorName}</span>
          <button
