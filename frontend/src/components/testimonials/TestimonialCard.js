    ...
    return (
        <div className="w-full h-full glass-card p-4 sm:p-5 flex flex-col justify-between group transition-all duration-300 hover:border-designColor/40">
            <div>
                ...
                <p className="text-gray-300 text-xs sm:text-sm leading-relaxed italic mb-5 line-clamp-4 group-hover:text-white transition-colors">
                    "{testimonial.message}"
                </p>
            </div>
            ...
            <div className="flex items-center gap-3 border-t border-white/5 pt-4 mt-auto">
                <div className="w-10 h-10 rounded-full overflow-hidden border border-designColor/30 shadow-md flex-shrink-0">
                    {testimonial.image || testimonial.image_display ? (
                        ...
                        <div className="w-full h-full bg-black/40 flex items-center justify-center text-sm font-bold text-designColor">
                            {testimonial.name?.charAt(0) || "U"}
                        </div>
                    )}
                </div>
                <div className="flex flex-col min-w-0">
                    <h3 className="text-sm font-bold text-white tracking-wide truncate group-hover:text-designColor transition-colors">
                        {testimonial.name}
                    </h3>
