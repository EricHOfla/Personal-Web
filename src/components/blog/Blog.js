    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lgl:gap-10">
        <div className="px-6">
          <BlogCard
            image={blogImgOne}
            title="September 16, 2023"
            subTitle="UI & UX Conference at Kigali 2022"
            category="Travel"
          />
          <BlogCard
            image={blogImgTwo}
          ...
          <BlogCard
            image={blogImgOne}
            title="July 13, 2022"
            subTitle="Designer Conference at Kigali, Rwanda 2022"
            category="Documentation"
          />
        </div>
        <div className="px-6">
          <BlogCard
            image={blogImgThree}
            title="July 13, 2021"
            subTitle="Designer Conference at Bujumbula, BURUNDI 2021"
            category="Documentation"
          />
          <BlogCard
            image={blogImgTwo}
